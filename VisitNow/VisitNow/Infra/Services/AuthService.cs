...
namespace VisitNow.Infra.Services
{
    ...
    {
        //public async Task<Backend.BackendResponseResult> Register(Models.DataModel data)
        //{
        //    Backend.BackendResponseResult _result = await GetBackendConnector().SaveOrUpdateAsync(data, "POST", @"/auth/company/register");
